...
Main = (function()
	...
	Main.CreateMainGui = function()
		...
		Main.CreateApp({Name = "Idk", IconMap = Main.LargeIcons, Icon = "Idk", Window = ScriptViewer.Window})

		Main.CreateApp({Name = "Plugins", IconMap = Main.LargeIcons, Icon = "Plugins", Window = ScriptViewer.Window})

		Main.CreateApp({Name = "Download", IconMap = Main.LargeIcons, Icon = "Download", Window = ScriptViewer.Window})
